...
public class String_ {
    public static void main(String[] args) {
        ...
        String s9 = "abc";
        // 这里s9指向了一个新的字符串对象 "abcdef" 原来的字符串对象 "abc" 没有被修改
        // 调用的也是StringBuffer的append方法 但是StringBuffer的append方法会返回一个新的字符串对象 "abcdef"
        // 使用String的拼接操作符 "+" 进行字符串拼接时 会在编译阶段将其转换为StringBuilder的append方法 但是StringBuilder的append方法会返回一个新的字符串对象 "abcdef"
        s9 = s9 + "def";
        ...
        // 查询字符串中是否包含某个字符串 用String
        String s11 = "hello world";
        boolean contains = s11.contains("a"); // true 判断字符串是否包含指定的字符或字符串
        // 查询字符串中是否包含指定的char字符
        String s12 = "hello world";
        boolean containsChar = s12.indexOf('a') != -1; // true 判断
